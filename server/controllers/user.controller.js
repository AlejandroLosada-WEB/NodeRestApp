...
userCTRL.createUser = async (req, res) => {
    ...
    if (iguales != null) {
        ...
        if (resul == null) {
            ...
            //LA CUENTA DE GOOGLE NO PERMITE ACCESO A APLICACIONES DESDE EL 30 de mayo del 2022,
...
userCTRL.deleteUser = async (req, res) => {
    let resul = await User.findByIdAndDelete(req.params.token);
    if (resul == null) {
...
userCTRL.activateUser = async (req, res) => {
    ...
    if (resul == null) {
        res.status(200).send({ Message: 'Error al activar el registro' });
    } else {
